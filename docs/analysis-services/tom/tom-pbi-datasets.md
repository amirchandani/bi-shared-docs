...
After creating the console application, add the **Microsoft.AnalysisServices.NetCore.retail.amd64** NuGet package which contains the Tabular Object Model (TOM). You can install the package in a .NET 5 application by using the following .NET CLI:
